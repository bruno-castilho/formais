...
EXECUCAO:  
   ...
   Necessário:
       --gramatica  #Arquivo que descreve a gramática livre de contexto.
        """
    parser_lexico = subparsers.add_parser('lexico', help='lexico -h', description=descricao_lexema,
                                          formatter_class=argparse.RawTextHelpFormatter)
    parser_lexico.add_argument('opcao', metavar='opcao', choices=['PROJETO', 'EXECUCAO'],
                               help='choices: {PROJETO,EXECUCAO}')
    parser_lexico.add_argument('-e', '--expressoes', metavar='', type=str,
                               help='arquivo de entrada (default: ./data/er.txt)')
    parser_lexico.add_argument('-a', '--automato', metavar='', type=str,
                               help='arquivo de entrada (default: ./data/AFD.txt)')
    parser_lexico.add_argument('-p', '--programa', metavar='', type=str,
                               help='arquivo de entrada (default: ./data/program.txt)')
    parser_lexico.add_argument('-w', '--palavras', metavar='', type=str,
                               help='arquivo de entrada (default: ./data/palavras_reservadas.txt)')
    ...
    parser_sintatico = subparsers.add_parser('sintatico', help='sintatico -h', description=descricao_ll,
                                             formatter_class=argparse.RawTextHelpFormatter)
    parser_sintatico.add_argument('opcao', metavar='opcao', choices=['EXECUCAO'], help='choices: {EXECUCAO}')
    parser_sintatico.add_argument('-g', '--gramatica', metavar='', type=str,
                                  help='arquivo de entrada (default: ./data/gramatica.txt)')
    parser_sintatico.add_argument('-s', '--sentenca', metavar='', type=str,
                                  help='arquivo de entrada (default: ./data/sentenca.txt)')
